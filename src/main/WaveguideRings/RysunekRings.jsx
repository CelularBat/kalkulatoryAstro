...
const RysunekRings = ({length,dHorn,ringWidth,ringDepth,ringPos,dBlock,blockPerc,L}) => {
  ...
  <svg
    ...
    viewBox="27.675 -71.2 201.525 104.302"
  >
    <g transform="scale(1 -1)">
      <path
        stroke="#000"
        strokeWidth="0.4"
        d="M120 0H40M120 50H40M100-20h20M120 70h-20M120 50h7M120 0h7"
      ></path>
      <path
        stroke="#000"
      ...
      <path
        stroke="#000"
        strokeWidth="0.4"
        d="M100-20V0M100 50v20M120 70V50M120-20V0"
      ></path>
      <path
        stroke="#000"
        strokeDasharray="1.905,0.9525"
      ...
      <path
        ...
        d="M38 25h91"
      ></path>
      <circle cx="183" cy="25" r="45" stroke="#000" strokeWidth="0.4"></circle>
      <circle cx="183" cy="25" r="25" stroke="#000" strokeWidth="0.4"></circle>
      <circle
        cx="183"
        cy="25"
        r="0.02"
      ...
      <path stroke="#000" strokeWidth="0.09" d="m88 -26.73 12.028.002"></path>
      <text
        fill="#000"
        dx="-15"
        dy="2.5"
